...
/// each() replacement test for php 7. Change all instances of each() to thisEach() in all TT files
...
///end each() replacement test

///mysqli_result for php 7 test. Change all mysql_result to mysqli_result in all TT files
